...
export default function Home() {
  ...
  return (
    <main className="container mx-auto">
      <h2 className={`text-4xl mt-4 ${andada_pro.className}`}>
      ...
      <h2 className={`text-2xl my-4 ${andada_pro.className}`}>
        Basics of margin
      </h2>
      <p>
      ...
      <h2 className={`text-2xl mt-4 ${andada_pro.className}`}>
        Basics of Flex layout
      </h2>

      <p className="my-4">
        By using flex, you can allocate elements within a block at equal
        intervals.
      </p>
      ...
      <section>
        <div>
          <Showcase
            title={"Step1: Initial menu items"}
            item={FlexExample1}
            showCode={true}
          />
          <article className="mt-6">
            This is the layout before applying flex. The link elements are
            aligned to the left within the block.
          </article>
        </div>
      </section>
      ...
      <section>
        <div>
          <Showcase
            title={"Step2: Apply flex layout"}
            item={FlexExample2}
            showCode={true}
          />
          <article className="mt-6">
            Added the classes `flex`, `flex-row`, `items-center` and
            `justify-center` to the nav element. The meanings of each class are
            as follows:
            <ul className="list-disc list-inside p-4">
              <li>`flex`: Makes the specified element a Flex container.</li>
              <li>
                `flex-row`: Arranges the children of the Flex container in a
                horizontal direction.
              </li>
              <li>
                `justify-center`: Centers the children along the main axis. In
                this case, as we have set the direction as row using "flex-row",
                this main axis is the horizontal axis.
              </li>
              <li>
                `items-center`: Centers the children along the cross axis. In
                this case, it's the vertical axis.
              </li>
            </ul>
          </article>
        </div>
      ...
      <section>
        <div>
          <Showcase
            title={"Step3: Align the navigation links to the right"}
            item={FlexExample3}
            showCode={true}
          />
